...
<div class="cabecalho">
	...
	<h3><center>
	    <?php  
            __('Escrever E-mail para todos os clientes');
...
<div>
	<?php
		...
		echo $ajax->form('email2', 'post', array('model'=>'Cliente', 'update'=> 'inicial', 'indicator'=>'ajax_load', 'after'=>'$("#inicial").empty();', 'class'=>'formulario')); 
	?>
	<br />
		<fieldset>
	 		<legend><?php __('destinatario');?></legend>
				...
				<?php
                                    ...
                                    //$div_update = $acao == 'edit' ? 'inicial' : 'inicial';
                                        ...
                                        echo $form->input('nome', array('label'=>'Clientes ', 'value'=>'TODOS', 'class'=>'tres_colunas'));					
                                        ...
                                        echo $form->input('email', array('label'=>'e-mails de todos clientes ', 'title'=>'Você pode excluir ou adicionar outros e-mails, separando-os por virgulas (,)', 'value'=> $todosEmails, 'type'=>'textarea', 'class'=>'textarea'));                                     
