...
<div class="cabecalho">
    <center><h3><?php __('Nova Conta'); ?></h3>
        ...
        <br>
        Esta nova conta será incluída e fará parte da rede <de></de>: <b><?= $nome ?></b>

    </center>
</div>
<div class="cx_listagem">
    <?php //echo $form->create('Usuario',array('type'=>'file', 'class'=>'form   ulario')); ?>
    <?php echo $ajax->form('add2', 'post', array('model' => 'Usuario', 'update' => 'inicial', 'indicator' => 'ajax_load', 'after' => '$("#inicial").empty();', 'class' => 'formulario')); ?>
