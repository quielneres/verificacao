    ...
    <?php if (!empty($usuarios)): ?> 
			...
			<table>
				...
				?>
                                    ...
                                    <?php if($plano > 1) {?>                                    
                                    <?php echo $ajax->link($html->image($feminino, array('title'=>$title)), array('controller'=> 'usuarios', 'action'=>'index5', $usuario['Usuario']['id']), array('update'=>'inicial', 'indicator'=>'ajax_load', 'before'=>'$("#inicial").empty();'), null, false); ?>
                                    <?php } else { ?>
                                    ...
                                    <?php if($plano > 1) {?>                                    
                                    <?php echo $ajax->link($html->image($masculino, array('title'=>$title)), array('controller'=> 'usuarios', 'action'=>'index5', $usuario['Usuario']['id']), array('update'=>'inicial', 'indicator'=>'ajax_load', 'before'=>'$("#inicial").empty();'), null, false); ?>
                                    <?php } else { ?>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp; 
                                        ...
                                        <?php
                                                //echo '<td class="acoes" width="1.6%">'.$ajax->link($html->image('restaurar.png', array('alt'=>'Mais Níveis', 'title'=>'Mais Níveis')), array('action'=>'index5', $usuario['Usuario']['id']), array('update'=>'inicial', 'indicator'=>'ajax_load', 'before'=>'$("#inicial").empty();'), null, false).'</td>';
