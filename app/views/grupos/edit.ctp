...
<div class="cabecalho">
	...
	<center><h3><?php __('Alterar Grupo'); ?></h3></center>
</div>
<div class="cx_listagem">
	<?php echo $ajax->form('edit', 'post', array('model'=>'Grupo', 'update'=>'inicial', 'indicator'=>'ajax_load', 'after'=>'$("#inicial").empty();', 'class'=>'formulario')); ?>
	<fieldset>
 		<legend><?php __('Geral');?></legend>
 		<?php 
 			echo $form->input('id');
 			echo $form->input('Descricao', array('label'=>'Descrição <b>(*)</b>', 'class'=>'uma_coluna', 'div'=>'sem_direita')); 
 		?>
	</fieldset>
	<fieldset>
	...
	<?php
		echo $form->submit('Atualizar', array('id'=>'submit_grupo'));
		echo $form->end(); 
	?>
</div>
